...
var file_pb_krk_stops_proto_rawDesc = []byte{
	...
	0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x22,
	...
	0x01, 0x32, 0xfe, 0x01, 0x0a, 0x08, 0x4b, 0x72, 0x6b, 0x53, 0x74, 0x6f, 0x70, 0x73, 0x12, 0x23,
	...
	0x70, 0x61, 0x72, 0x74, 0x75, 0x72, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x25, 0x0a, 0x0b, 0x53,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x74, 0x6f, 0x70, 0x73, 0x12, 0x0b, 0x2e, 0x53, 0x74, 0x6f,
	0x70, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x1a, 0x05, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x22, 0x00,
...
var file_pb_krk_stops_proto_goTypes = []interface{}{
	...
	(*Stop)(nil),                 // 5: Stop
	(*StopSearch)(nil),           // 6: StopSearch
}
var file_pb_krk_stops_proto_depIdxs = []int32{
	0, // 0: Departure.type:type_name -> Endpoint
	0, // 1: Stop.type:type_name -> Endpoint
	1, // 2: KrkStops.GetAirly:input_type -> Installation
	3, // 3: KrkStops.FindNearestAirlyInstallation:input_type -> InstallationLocation
	1, // 4: KrkStops.GetAirlyInstallation:input_type -> Installation
	5, // 5: KrkStops.GetDepartures:input_type -> Stop
	6, // 6: KrkStops.SearchStops:input_type -> StopSearch
	2, // 7: KrkStops.GetAirly:output_type -> Airly
	1, // 8: KrkStops.FindNearestAirlyInstallation:output_type -> Installation
	1, // 9: KrkStops.GetAirlyInstallation:output_type -> Installation
	4, // 10: KrkStops.GetDepartures:output_type -> Departure
	5, // 11: KrkStops.SearchStops:output_type -> Stop
